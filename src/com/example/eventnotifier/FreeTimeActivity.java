...
public class FreeTimeActivity extends Activity {
	private final static String TAG = "FreeTimeActivity";
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					Toast.makeText(FreeTimeActivity.this, "Unknown host.", Toast.LENGTH_SHORT).show();
				} catch (IOException e) {
					Log.e(TAG, "Error opening client socket.");
					Toast.makeText(FreeTimeActivity.this, "Cannot open socket..", Toast.LENGTH_SHORT).show();
				}
