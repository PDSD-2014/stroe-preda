...
public class HolidaysActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.holidays_main);
		context = this;
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					Toast.makeText(HolidaysActivity.this, "Unknown host.", Toast.LENGTH_SHORT).show();
				} catch (IOException e) {
					Log.e(TAG, "Error opening client socket.");
					Toast.makeText(HolidaysActivity.this, "Cannot open socket..", Toast.LENGTH_SHORT).show();
				}
