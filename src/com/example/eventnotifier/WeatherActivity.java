		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				try {
					...
					Toast.makeText(WeatherActivity.this, "Unknown host.", Toast.LENGTH_SHORT).show();
				} catch (IOException e) {
					Log.e(TAG, "Error opening client socket.");
					Toast.makeText(WeatherActivity.this, "Cannot open socket..", Toast.LENGTH_SHORT).show();
				}
